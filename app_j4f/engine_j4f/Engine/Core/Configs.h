...
namespace engine {
	...
	struct EngineConfig {
		FpsLimitType fpsLimitTypeDraw = FpsLimitType::F_CPU_SLEEP;
        FpsLimitType fpsLimitTypeUpdate= FpsLimitType::F_CPU_SLEEP;
		uint16_t fpsDraw = 120;
        uint16_t fpsUpdate = 60;
